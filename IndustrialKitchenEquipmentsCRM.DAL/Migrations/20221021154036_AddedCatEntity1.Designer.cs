...
namespace IndustrialKitchenEquipmentsCRM.DAL.Migrations
{
    ...
    [Migration("20221021154036_AddedCatEntity1")]
    partial class AddedCatEntity1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndustrialKitchenEquipmentsCRM.Entities.Auth.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IndustrialKitchenEquipmentsCRM.Entities.Card.Card", b =>
                {
                    b.HasOne("IndustrialKitchenEquipmentsCRM.Entities.Auth.AppUser", "AppUser")
                        .WithOne("Card")
                        .HasForeignKey("IndustrialKitchenEquipmentsCRM.Entities.Card.Card", "AppUserId")
            ...
            modelBuilder.Entity("IndustrialKitchenEquipmentsCRM.Entities.Card.CardItem", b =>
                {
                    b.HasOne("IndustrialKitchenEquipmentsCRM.Entities.Card.Card", null)
                        .WithMany("CardItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("IndustrialKitchenEquipmentsCRM.Entities.Auth.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("IndustrialKitchenEquipmentsCRM.Entities.Auth.AppUser", null)
                        .WithMany()
